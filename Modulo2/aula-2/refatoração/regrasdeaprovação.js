...
//  Modificar as regas de aprovação

function verificarSituacao(media, notaAprovacao, notaRecuperacao){
 if (media >= prompt(`Digite a média mínima para aprovação`)) return "Aprovado";
 if (media >= prompt(`Digite a média mínima para reprovação`)) return "Recuperação";
}
